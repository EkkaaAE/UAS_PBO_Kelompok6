...
public class DataHP implements Pajak{
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Harga: " + hp1.harga);
        System.out.println("Harga setelah ditambahkan PAJAK: " + hp1.hitungPajak());

        System.out.println("\nhp ke-2:");
        System.out.println("Vendor: " + hp2.vendor);
        System.out.println("Tipe: " + hp2.tipe);
        System.out.println("Harga: " + hp2.harga);
        System.out.println("Harga setelah ditambahkan PAJAK: " + hp2.hitungPajak());

        System.out.println("\nhp ke-3:");
        System.out.println("Vendor: " + hp3.vendor);
        System.out.println("Tipe: " + hp3.tipe);
        System.out.println("Harga: " + hp3.harga);
        System.out.println("Harga setelah ditambahkan PAJAK: " + hp3.hitungPajak());
    }
}
